...
!(function () {
	...
	function l(t, n, r) {
		...
		return (i = t[E][n] = { id: n, i: o, n: s, I: u, L: c, h: !1, d: void 0, e: void 0, er: void 0, E: void 0, C: void 0, p: void 0 });
	}
	function d() {
				...
				return new Promise(function (o, s) {
					r.addEventListener("error", function () {
						...
						r.addEventListener("load", function () {
							if ((document.head.removeChild(r), I === t)) s(W);
							else {
								var e = i.getRegister(t);
								e && e[0] === j && clearTimeout(P), o(e);
							}
						}),
	...
	(O.instantiate = function (t, n) {
		...
		return this.shouldFetch(t)
			? this.fetch(t, { credentials: "same-origin", integrity: L.integrity[t] }).then(function (i) {
					...
					if (!o || !N.test(o)) throw Error(e(4, 'Unknown Content-Type "' + o + '", loading ' + t + (n ? " from " + n : "")));
	...
	(O.instantiate = function (e, t) {
		...
		(function (e) {
			function t(t) {
				return !e.hasOwnProperty(t) || (!isNaN(t) && e.length > t) || (a && e[t] && "undefined" != typeof window && e[t].parent === window);
			}
			var n,
				r,
				i,
				...
				return u(t, r).then(function (r) {
					...
					return i.test(u)
						? r.json().then(function (e) {
								return new Response(
									new Blob(['System.register([],function(e){return{execute:function(){e("default",' + JSON.stringify(e) + ")}}})"], {
						...
						: s.test(u)
						? (WebAssembly.compileStreaming ? WebAssembly.compileStreaming(r) : r.arrayBuffer().then(WebAssembly.compile)).then(function (
								n
						  ) {
